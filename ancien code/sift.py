...
from octaves import gaussian_filter, generate_octaves, generate_DOG_octaves
...
class SIFT(object):
    ...
    def get_features(self):
        gaussian_pyr = generate_octaves(self.im, self.num_octave, self.s, self.sigma)
        DoG_pyr = generate_DOG_octaves(gaussian_pyr)
